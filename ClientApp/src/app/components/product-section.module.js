...
let ProductSectionModule = class ProductSectionModule {
};
ProductSectionModule = __decorate([
    NgModule({
        imports: [
            DxLookupModule,
            DxDateBoxModule,
...
export { ProductSectionModule };
//# sourceMappingURL=product-section.module.js.map